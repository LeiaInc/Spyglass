...
import com.linkedin.android.spyglass.sample.samples.MentionsAndHashtags;
...
public class SamplesActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.mentions_and_hashtags_sample)
                .setOnClickListener(v -> startActivity(new Intent(SamplesActivity.this, MentionsAndHashtags.class)));
    }
}
